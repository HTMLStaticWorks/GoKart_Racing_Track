...
const targetStr = '<p class="footer-col-desc">Next-generation premium racing destination with cinematic visualizers, dynamic telemetry, and realistic go-karting experiences.</p>';
...
files.forEach(file => {
    ...
    if (content.includes(targetStr) && !content.includes('footer-socials')) {
